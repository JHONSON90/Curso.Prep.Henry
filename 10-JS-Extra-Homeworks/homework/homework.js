...
function deleteAbc(cadena){
  ...
  var NewCadena = cadena.split('').filter((e) => e !== "a" && e !== "b" && e !== "c").join("")
  return NewCadena
// tambien puede hacerlo en una sola linea asi return cadena.split('').filter((e) => e !== "a" && e !== "b" && e !== "c").join("")
}
...
/* let Newarr = [];
for (let i = 0; i < arreglo1.length; i++) { 
  if (arreglo2.incluides(arreglo[i])){
